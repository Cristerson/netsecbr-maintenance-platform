-- Entrega 9: ficha técnica, peças e preparação para monitoramento.
...
grant select, insert, update on public.asset_technical_profiles, public.work_order_parts, public.monitoring_rules, public.monitoring_events to authenticated;
